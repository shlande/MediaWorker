...
// Run starts the periodic rebalance loop. Every 10 minutes it fetches the top
// 5000 contents by popularity and calls the registered strategy's AdjustPin
// for each, delivering per-node PinPlans. Panics during a rebalance round are
// recovered so subsequent rounds continue uninterrupted.
